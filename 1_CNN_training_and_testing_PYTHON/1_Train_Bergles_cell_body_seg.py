...
(X,Y), (X_val,Y_val), axes = load_training_data('training_data_Bergles_cell_tracking.npz', validation_split=0.1)
    ...
    for i in range(len(X)):
        ...
        if len(batch_x) == batch_size:
           ...
           if epochs % save_epoch == 0:                          
              ...
              save_pkl(plot_sens, s_path, 'jacc_t.pkl')
              save_pkl(plot_sens_val, s_path, 'jacc_val.pkl')
              
              save_pkl(plot_prec, s_path, 'jacc_t.pkl')
              save_pkl(plot_prec_val, s_path, 'jacc_val.pkl')
