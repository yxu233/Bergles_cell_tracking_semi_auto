...
for fileNum = 1:2:numfids
    ...
    for loop_idx = 1:length(idx_original_seed)
        ...
        [all_original_seeds, save_linear_indices] = recurse_branch_tree_by_pixels(originalIdx, all_original_seeds, sortedS, depth_limit, size(input_im), save_linear_indices);
