...
function return_crop_im = return_crop_around_centroid(input_im, crop, y, x, z, crop_size, z_size, height, width, depth)
...
return_crop_im = zeros(size(input_im));
return_crop_im(box_x_min:box_x_max - 1, box_y_min:box_y_max - 1, box_z_min:box_z_max - 1) = crop;
end
