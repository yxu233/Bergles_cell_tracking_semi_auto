function [full_single_path, save_linear_indices] = recurse_branch_tree(originalIdx, full_single_path, sortedS, depth_limit, siz, save_linear_indices)
...
%                 end
                ...
                [full_single_path, save_linear_indices] = recurse_branch_tree(branchIdxVal, full_single_path, sortedS, depth_limit - 1, siz, save_linear_indices);
